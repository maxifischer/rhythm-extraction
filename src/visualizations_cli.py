...
model_names = ["simple_cnn--linvar", "simple_cnn", "linear--linvar", "linear", "big_cnn--linvar", "big_cnn",
               "linear--linvar", "linear", "mean_svm"]
...
def run_on_all(experiment):
    cols = ['data_name', 'prepr_name', 'model_name', 'param_c', 'param_gamma', 'param_linvar', 'test_acc', 'test_f1',
            'test_acc_pc', 'test_acc_nc', 'cv_acc', 'cv_f1', 'cv_acc_pc', 'cv_acc_nc']
